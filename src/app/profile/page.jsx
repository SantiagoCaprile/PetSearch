...
export default async function UserProfile() {
  ...
  return (
    <div className="md:w-3/5 md:m-auto p-4 md:p-8 bg-white">
      <div className="flex flex-col lg:flex-row pb-2 items-center justify-center md:justify-evenly">
        ...
        <div className="w-full md:w-2/3 mb-6 md:pl-6 flex flex-col">
          ...
          <Link
            href="/personalform"
            className="bg-blue-500 hover:bg-blue-600 transition-all text-white px-4 py-2 rounded-md flex gap-1 items-center justify-center xl:w-2/3"
          >
