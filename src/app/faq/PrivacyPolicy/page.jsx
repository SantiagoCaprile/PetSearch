export default function PrivacyPolicyPage() {
    return (
        <div className="grid mx-auto text-wrap md:max-w-[800px]">
            ...
            <ul className="list-disc ml-8 mb-4">
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to PetSearch.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to PetSearch, accessible from <a href="https://www.petsearch.com.ar/" rel="external nofollow noopener" target="_blank">https://www.petsearch.com.ar/</a></p>
                </li>
                <li>
            ...
            <h4 className="text-lg font-bold mb-2">Information from Third-Party Social Media Services</h4>
            ...
            <h4 className="text-lg font-bold mb-2">Use of Your Personal Data</h4>
            ...
            <h3 className="text-lg font-bold mb-2">Retention of Your Personal Data</h3>
            ...
            <h3 className="text-lg font-bold mb-2">Transfer of Your Personal Data</h3>
            ...
            <h3 className="text-lg font-bold mb-2">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-bold mb-2">Business Transactions</h4>
            ...
            <h4 className="text-lg font-bold mb-2">Law enforcement</h4>
            ...
            <h4 className="text-lg font-bold mb-2">Other legal requirements</h4>
            ...
            <h3 className="text-lg font-bold mb-2">Security of Your Personal Data</h3>
            ...
            <ul className="list-disc ml-8 mb-4">
                <li>By visiting this page on our website: <a href="https://www.petsearch.com.ar/contact" rel="external nofollow noopener" target="_blank">https://www.petsearch.com.ar/contact</a></li>
            </ul>
        </div>
    )
}